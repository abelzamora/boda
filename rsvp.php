...
<head profile="http://www.w3.org/1999/xhtml/vocab">
    ...
    <link rel="shortcut icon" href="http://sarahlovesbradley.com/d/sites/default/files/favicon.ico"
    ...
    <style type="text/css"
           media="all">@import url("http://sarahlovesbradley.com/d/modules/system/system.base.css?mowwhq");
    ...
    <style type="text/css"
           media="all">@import url("http://sarahlovesbradley.com/d/sites/all/modules/webform/css/webform.css?mowwhq");</style>
    <style type="text/css"
           media="screen">@import url("http://sarahlovesbradley.com/d/sites/all/themes/rsvp/reset.css?mowwhq");
...
<body onload="resize();"
      class="html front not-logged-in no-sidebars page-node page-node- page-node-1 node-type-webform">
<div id="skip-link">
        ...
        <div class="region region-content">
            <div id="block-system-main" class="block block-system">
                ...
                <div class="content">
                    ...
                    <div id="node-1" class="node node-webform node-promoted" about="/d/rsvp"
                            ...
                            <div class="field field-name-body field-type-text-with-summary field-label-hidden">
                                <div class="field-items">
                                    <div class="field-item even" property="content:encoded">
                                        <div class="title">Por favor, responder antes de</div>
                                        <div class="sub">el uno de Julio</div>
                                    </div>
                                </div>
                            </div>
                            <form class="webform-client-form" enctype="multipart/form-data" action="rsvp_email.php"
                                ...
                                <div>
                                    <div
                                        ...
                                        id="webform-component-name">
                                        <label for="edit-submitted-name">Nombre <span class="form-required"
                                                                                      title="This field is required.">*</span></label>
                                        <input type="text" id="name" name="name"
                                               value="<?php echo $_SESSION["name"]; ?>" size="30" maxlength="128"
                                               class="form-text required"/>
                                    </div>
                                    <div
                                        class="form-item webform-component webform-component-email webform-container-inline"
                                        id="webform-component-email">
                                        <label for="edit-submitted-email">Email <span class="form-required"
                                                                                      title="This field is required.">*</span></label>
                                        <input class="email form-text form-email required" type="email" id="email"
                                               value="<?php echo $_SESSION["email"]; ?>" name="email" size="50"/>
                                    </div>
                                    <fieldset class="webform-component-fieldset form-wrapper"
                                              id="webform-component-label-entree">
                                        <legend><span class="fieldset-legend">Dinos si vas a venir</span></legend>
                                        <div class="fieldset-wrapper">
                                            <div class="form-item webform-component webform-component-radios"
                                                 id="webform-component-label-entree--entree">
                                                <div id="edit-submitted-attendance" class="form-radios">
                                                    <div
                                                        class="form-item form-type-radio form-item-submitted-attendance">
                                                        <input type="radio" id="voy" name="voy" value="voy"
                                                               class="form-radio"/> <label class="option" for="voy">Si,
                                                            voy a ir </label>
                                                    </div>
                                                    <div
                                                        class="form-item form-type-radio form-item-submitted-attendance">
                                                        <input type="radio" id="noVoy" name="noVoy" value="noVoy"
                                                               class="form-radio"/> <label class="option" for="noVoy">No,
                                                            no voy a ir </label>
                                    ...
                                    <fieldset class="webform-component-fieldset form-wrapper"
                                              id="webform-component-label-entree">
                                        <legend><span class="fieldset-legend">Color del vestido de la mujer?</span>
                                        </legend>
                                        <div class="fieldset-wrapper">
                                            <div class="form-item webform-component webform-component-radios"
                                                 id="webform-component-label-entree--entree">
                                                <input class="email form-text form-email" type="text" id="color"
                                                       value="" name="color" size="15"/>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset class="webform-component-fieldset form-wrapper"
                                              id="webform-component-label-accommodations">
                                        <legend><span class="fieldset-legend">Talla calzado mujer?</span></legend>
                                        <div class="fieldset-wrapper">
                                            <div class="form-item webform-component webform-component-radios"
                                                 id="webform-component-label-accommodations--accommodations">
                                                <input class="email form-text form-email" type="text" id="talla"
                                                       value="" name="talla" size="10" autocomplete="off"/>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="form-item webform-component webform-component-markup"
                                         id="webform-component-bg">

                                    </div>
                                    <div class="form-item webform-component webform-component-textarea"
                                         id="webform-component-message">
                                        <label for="edit-submitted-message">&nbsp; </label>

                                        <div class="form-textarea-wrapper"><textarea id="edit-submitted-message"
                                                                                     name="mensaje" cols="10" rows="5"
